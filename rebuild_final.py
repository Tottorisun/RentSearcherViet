...
<div class="page">
  ...
  <footer class="footer">
    ...
    <p class="stamp">Данные актуальны на 17 августа 2026 · объявления старше 30 дней исключены из подборки · перед созвоном с хозяином всегда проверяйте цену и наличие по ссылке на объявление.</p>
  </footer>
