...
заведением шаблонных постов переехали на Netcup, см. ниже) — `IN PROGRESS`:
ждёт первого серверного прогона с Telegram, 12.09.2026 17:00 по Вьетнаму.
...
**Evidence первого серверного прогона с Telegram:** ожидается 12.09.2026 после
17:00 по Вьетнаму.
